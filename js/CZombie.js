var CZombies = function(b, a) {
    return (a = function() {}).prototype = {
        ...
        ChangeR: function(e) {
            ...
            q = f.childNodes[1],
            j = oGd.$LF,
            c; ! g.length && (d.CanPass(r, j[r]) && (g[++n] = r), d.CanPass(r += 2, j[r]) && (g[++n] = r));
            ...
            }), d.isAttacking && (q.src = d.PicArr[d.NormalGif]), oZ.moveTo(l, h, r)) : q.src = d.PicArr[d.NormalGif];
            d.isAttacking = 0
        },
...
{
    PicArr: {
        0 : "images/Zombies/Zombie/Zombie2.gif"
    }
}),
...
{
    PicArr: {
        0 : "images/Zombies/Zombie/Zombie3.gif"
    }
}),
