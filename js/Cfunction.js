...
oS = {
    ...
    Init: function(e, g, b, d) {
        ...
        for (c in e) {
            ...
            this[c] = e[c]
        } ! this.PicArr && (this.PicArr = []); ! this.PName && (this.PName = []); ! this.ZName && (this.ZName = []); ! this.backgroundImage && (this.backgroundImage = "images/interface/background1.jpg"); ! this.LF && (this.LF = [0, 1, 1, 1, 1, 1]); ! this.ZF && (this.ZF = this.LF); ! this.LargeWaveFlag && (this.LargeWaveFlag = {}); ! this.StartGameMusic && (this.StartGameMusic = "UraniwaNi.swf");
        ...
        this.ProduceSun == d && (this.ProduceSun = true); (this.Coord ||
        function() {
            oS.R = 5;
    ...
    CheckImg: function(b, a) {
        ...
        if (c.AccessNum == c.PicNum) {
            ...
            function() {
                ...
                []) : (SetBlock($("dMenu")), AutoSelectCard(), LetsGO())
            })()
        }
    }
},
oP = {
    Init: function(b) {
        ...
        oP.FlagNum && (this.LAr = this.ArZ.length, this.FlagHeadStep = Math.floor(140 / (b.FlagNum - 1))); ! b.FlagToEnd && (oP.FlagToEnd = function() {
...
oZ = {
    ...
    traversalOf: function() {
        ...
        i, k = Refresh = 0,
        j = 1000,
        h, g, b = function(m) { (h = m.AttackedLX) > j && (k = Refresh = 1);
            j = h
        },
        d = function(m) {
            Refresh = 1;
        ...
        l; (function(p) {
            ...
            while (n--) {
                c = i[n];
                c.HP && c.ZX < 901 && oT.check(c); ! c.HP ? (i.splice(n, 1), d(c)) : !(c.FreeFreezeTime || c.FreeSetbodyTime) ? (c.beAttacked && !c.isAttacking && c.JudgeAttack(), g = c.id, !c.isAttacking ? (a = c.Speed, !c.WalkDirection ? ((l = c.AttackedRX -= a) < 0 ? (i.splice(n, 1), c.Die(2), d(c)) : (l < 100 && !c.PointZombie && (c.PointZombie = 1, c.ChangeR({
                    R: p,
                    ar: [oS.R - 1],
            ...
            }), i.RefreshTime = oSym.Now) : Refresh && (i.RefreshTime = oSym.Now); --p && oSym.addTask(0, m, [p])
        })(e.length - 1)
    }
},
oT = {
...
GroundOnmousedown = function(i) {
    i = window.event || i;
    var a = i.clientX + document.documentElement.scrollLeft,
    k = i.clientY + document.documentElement.scrollTop,
    g = ChosePlantX(a),
    h = ChosePlantY(k),
    d = g[0],
    c = h[0],
...
GroundOnmousemove = function(k) {
    k = window.event || k;
    var d = k.clientX + document.documentElement.scrollLeft,
    b = k.clientY + document.documentElement.scrollTop,
    m = oS.ChoseCard,
    h = ChosePlantX(d),
    i = ChosePlantY(b),
    f = h[0],
...
SelectCard = function(e) {
    ...
    if (!b.Select) {
        ...
        b.Select = 0; ! --ArPCard.SelNum && (f.disabled = "disabled", f.style.color = "#888"); (h = $("dCard" + e)).onclick = null;
...
LetsGO = function() {
    ...
    SetVisible(f); ! oS.BrainsNum && CustomSpecial(oBrains, oS.R - 1, -2);
    oGd.MoveBullet(); (oS.StartGame ||
    function() {
        ClearChild($("oEmbed"));
...
MonitorCard = function(c) {
    ...
    b;
    if (oS.Chose < 1) {
        while (a--) { (b = (c = ArCard[a]).PName.prototype).SunNum > oS.SunNum ? (c.SunReady && (c.SunReady = 0), SetNone($(c.DID).childNodes[1])) : (!c.SunReady && (c.SunReady = 1), c.CDReady && (SetBlock($(c.DID).childNodes[1])))
        }
    } else {
...
ChosePlant = function(a, f) {
    ...
    c = ArCard.length,
    b;
    oS.Chose = 1; ! oS.CardKind ? EditImg((EditImg($Pn[d.EName].childNodes[1].cloneNode(false), "MovePlant", "", {
...
GrowPlant = function(k, d, c, e, b) {
    ...
    h = j.coolTime,
    a;
    j.CanGrow(k, e, b) && (!oS.CardKind ? (new g).Birth(d, c, e, b, k) : asyncInnerHTML((a = new g).CustomBirth(e, b, 0, "auto"),
    function(m, l) {
        EDAll.appendChild(m);
        l.Birth()
    },
...
CustomSpecial = function(b, a, c) { (new b).Birth(GetX(c), GetY(a), a, c, [])
},
...
LoadProProcess = function() {
    ...
    !$("dText1") && b.insertBefore(NewEle("dText1", "div", 0, {
        innerHTML: '<span style="line-height:1.5;width:524px;font-size:15px; font-family:&#x9ED1;&#x4F53;;color:#F60; top:32px">&#x6B22;&#x8FCE;&#x6765;&#x5230;<span style="font-family:Verdana">LonelyStar</span>&#x7684;<span style="font-family:Verdana">JavaScript</span>&#x7248;&#x690D;&#x7269;&#x5927;&#x6218;&#x50F5;&#x5C38;<br>&#x5728;&#x7EBF;&#x7F51;&#x5740; <span style="font-family:Verdana">http://pvz.lonelystar.org</span><br><b>&#x7A0B;&#x5E8F;&#x7684;&#x5F00;&#x53D1;&#x76EE;&#x7684;&#x662F;&#x4E3A;&#x4E86;&#x5B66;&#x4E60;&#xFF0C;&#x6240;&#x6709;&#x7248;&#x6743;&#x5F52;PopCap&#x6240;&#x6709;<br><a href="http://www.xiazai.com" target="_blank"  style="color:#FF0;font-size:14px;text-decoration: none">&#21512;&#20316;&#20249;&#20276;&#65306;&#65;&#53;&#19979;&#36733;</a></b></span><br><a  style="color:#FF0;font-size:14px;text-decoration: none" href="http://www.lonelystar.org/view" target="_blank">&#28857;&#20987;&#36825;&#37324;&#21040;&#20316;&#32773;&#30041;&#35328;&#26495;&#65292;&#26080;&#38656;&#27880;&#20876;&#30331;&#24405;</a><br><br>'
    },
    0), b.firstChild), a.src = "http://kainy.googlecode.com/svn/trunk/%E6%A4%8D%E7%89%A9%E5%A4%A7%E6%88%98%E5%83%B5%E5%B0%B8%EF%BC%88pvz%EF%BC%89JavaScript%E7%89%88/js/Process.js") : $("sTime").innerHTML = oS.Version
},
$ = function(a) {
